...
import {deleteTodoList, insertNewTodoList} from '../databases/allSchemas';
            ...
            <Swipeout2 right={[
                {
                    ...
                    <TouchableHighlight onPress={() => {this.props.onPress(App_music,dataSendToDetail);}} style={styles.button}>
...
const styles = StyleSheet.create({
    button:{backgroundColor:"white",height:50,borderColor:"black",borderWidth:1},
